...
const AppointmentFilters: React.FC = () => {
  ...
  const statusOptions = [
    { value: 'all', label: 'All Status', icon: Eye, color: 'from-gray-500 to-gray-600' },
    { value: 'confirmed', label: 'Confirmed', icon: CheckCircle, color: 'from-green-500 to-emerald-600' },
    { value: 'pending', label: 'Pending', icon: AlertCircle, color: 'from-yellow-500 to-orange-600' },
    { value: 'completed', label: 'Completed', icon: CheckCircle, color: 'from-blue-500 to-cyan-600' },
    { value: 'cancelled', label: 'Cancelled', icon: XCircle, color: 'from-red-500 to-pink-600' }
  ];

  const sortOptions = [
    { value: 'newest', label: 'Newest First', icon: TrendingUp },
    { value: 'oldest', label: 'Oldest First', icon: Clock },
    { value: 'name', label: 'Client Name', icon: User },
    { value: 'status', label: 'Status', icon: Star }
  ];

  const quickFilters = [
    { label: 'Today', value: 'today', color: 'from-blue-500 to-cyan-600' },
    { label: 'This Week', value: 'week', color: 'from-green-500 to-emerald-600' },
    { label: 'This Month', value: 'month', color: 'from-purple-500 to-violet-600' },
    { label: 'Upcoming', value: 'upcoming', color: 'from-orange-500 to-red-600' }
  ];
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Find and organize your appointments</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-gray-200/50 dark:border-gray-600/50">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
            Showing <span className="font-bold text-gray-900 dark:text-white">24</span> of <span className="font-bold text-gray-900 dark:text-white">156</span> appointments
          </span>
        </div>
